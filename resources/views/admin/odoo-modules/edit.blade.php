...
@section('title', 'Modifier Module Odoo')

@section('content')
    <div class="md:flex md:items-center md:justify-between mb-6">
        <div class="min-w-0 flex-1">
            <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Modifier Module Odoo</h2>
        </div>
    </div>

    <div class="mt-8">
        <form action="{{ route('admin.odoo-modules.update', $odooModule) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name_fr" id="name_fr" value="{{ old('name_fr', $odooModule->getTranslation('name', 'fr')) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="name_en" id="name_en" value="{{ old('name_en', $odooModule->getTranslation('name', 'en')) }}" required
                                class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6">
                            @error('name_en')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="icon" id="icon" value="{{ old('icon', $odooModule->icon) }}" required
                                class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6"
                        ...
                        <div>
                            ...
                            <textarea name="description_fr" id="description_fr" rows="3" required
                                class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6">{{ old('description_fr', $odooModule->getTranslation('description', 'fr')) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="description_en" id="description_en" rows="3" required
                                class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6">{{ old('description_en', $odooModule->getTranslation('description', 'en')) }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="url" name="link" id="link" value="{{ old('link', $odooModule->link) }}"
                                class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6"
                        ...
                        <div>
                            ...
                            <input type="number" name="order" id="order" value="{{ old('order', $odooModule->order) }}"
                                class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6">
                            @error('order')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
