...
@section('content')
    <div class="md:flex md:items-center md:justify-between mb-6">
        <div class="min-w-0 flex-1">
            <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Nouvelle Offre</h2>
        </div>
    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="currency" id="currency" value="{{ old('currency', 'CFA') }}" required
                                    class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6">
                                @error('currency')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="text" name="billing_period" id="billing_period" value="{{ old('billing_period', 'par mois') }}" required
                                    class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="button_text" id="button_text" value="{{ old('button_text', 'Configurer') }}" required
                                    class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6">
                                @error('button_text')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="color" id="color"
                                    ...
                                    <option value="primary" {{ old('color') == 'primary' ? 'selected' : '' }}>🔵 Primary (Bleu)</option>
                                    <option value="secondary" {{ old('color') == 'secondary' ? 'selected' : '' }}>🟢 Secondary (Vert/Teal)</option>
                                    <option value="accent" {{ old('color') == 'accent' ? 'selected' : '' }}>🟣 Accent (Indigo)</option>
