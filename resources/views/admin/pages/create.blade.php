            ...
            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div class="sm:col-span-4 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                             <x-translatable-textarea name="content" id="content" rows="15" :wysiwyg="true" :value="old('content')" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <x-translatable-textarea name="meta_description" id="meta_description" rows="3" :value="old('meta_description')" />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <x-translatable-textarea name="meta_keywords" id="meta_keywords" rows="2" :value="old('meta_keywords')" />
                                </div>
                            </div>
                        </div>
                    </div>
