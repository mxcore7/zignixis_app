...
<div class="lg:flex lg:items-center lg:justify-between mb-8">
    <div class="min-w-0 flex-1">
        <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Modifier Page</h2>
    </div>
</div>
            ...
            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div class="sm:col-span-4 space-y-6">
                    <div>
                        ...
                        <div class="mt-2">
                             <x-translatable-input name="title" id="title" :value="old('title', $page->getTranslations('title'))" required />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="text" name="slug" id="slug" value="{{ old('slug', $page->slug) }}" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                ...
                <div class="sm:col-span-2 space-y-6">
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="mt-4 flex items-center">
                            <input id="is_active" name="is_active" type="checkbox" value="1" {{ old('is_active', $page->is_active) ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                            <label for="is_active" class="ml-2 block text-sm text-gray-900">Publier la page</label>
                        </div>
                         <div class="mt-4 pt-4 border-t border-gray-200">
                             <p class="text-sm text-gray-500 mb-2">Dernière modification : {{ $page->updated_at->format('d/m/Y H:i') }}</p>
                             <a href="{{ url($page->slug) }}" target="_blank" class="text-indigo-600 hover:text-indigo-900 text-sm flex items-center">
                                 Voir la page <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
                             </a>
                         </div>
                    </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div class="mt-1">
                                    <x-translatable-input name="meta_title" id="meta_title" :value="old('meta_title', $page->getTranslations('meta_title') ?? [])" />
                                </div>
                            </div>
