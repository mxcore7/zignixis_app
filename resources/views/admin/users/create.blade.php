...
@section('content')
    ...
    <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8 divide-y divide-gray-200">
        @csrf
            ...
            <div class="space-y-6 sm:space-y-5">
                ...
                <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        ...
                        <p class="mt-2 text-sm text-gray-500">JPG, PNG ou GIF (max. 2MB)</p>
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <div class="relative flex items-start">
                            <div class="flex h-6 items-center">
                                <input id="is_active" name="is_active" type="checkbox" value="1" checked class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-600">
                            </div>
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            @foreach($permissions as $key => $label)
                                <div class="relative flex items-start">
                                    <div class="flex h-6 items-center">
                                        <input id="perm_{{ $key }}" name="permissions[]" type="checkbox" value="{{ $key }}" class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-600">
                                    </div>
                                    <div class="ml-3 text-sm leading-6">
