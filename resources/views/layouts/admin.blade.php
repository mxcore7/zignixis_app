                ...
                <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4 ring-1 ring-white/10">
                    ...
                    <li>
                        <ul role="list" class="-mx-2 space-y-1">
                            ...
                            <li>
                                <a href="{{ route('admin.post-categories.index') }}" class="{{ request()->routeIs('admin.post-categories.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold transition-colors">
                                    <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            @can('admin')
                            <li>
                                <a href="{{ route('admin.offers.index') }}" class="{{ request()->routeIs('admin.offers.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold transition-colors">
                            ...
                            <li>
                                <a href="{{ route('admin.quotes.index') }}" class="{{ request()->routeIs('admin.quotes.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold transition-colors">
                                    <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    ...
                                    @if(\App\Models\Quote::where('status', 'new')->count() > 0)
                                        <span class="ml-auto w-9 min-w-max whitespace-nowrap rounded-full bg-red-600 px-2.5 py-0.5 text-center text-xs font-medium leading-5 text-white ring-1 ring-inset ring-red-500" aria-hidden="true">{{ \App\Models\Quote::where('status', 'new')->count() }}</span>
                                    @endif
                                </a>
                            </li>
                            @endcan
                            ...
                            <div class="py-2">
                                ...
                                @if($notifications->count() > 0)
                                    <div class="border-t border-gray-200 px-4 py-2">
                                        <a href="{{ route('admin.notifications.index') }}" class="text-sm text-primary-600 hover:text-primary-700 font-medium">Voir toutes les notifications →</a>
                                    </div>
                                @endif
                            </div>
                        </div>
