<div class="bg-white rounded-2xl shadow-lg p-8">
    ...
    @if($success)
        <div class="mb-6 p-4 rounded-md bg-green-50 border border-green-200">
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-green-800">{{ __('Votre message a été envoyé avec succès. Nous vous répondrons dans les plus brefs délais.') }}</p>
                </div>
            </div>
        </div>
    @endif
    ...
    <form wire:submit.prevent="submit" class="space-y-6">
        <div class="grid sm:grid-cols-2 gap-6">
            <div>
                <label for="firstName" class="block text-sm font-semibold leading-6 text-gray-900">{{ __('Prénom') }}</label>
                <div class="mt-2.5">
            ...
            <div>
                <label for="lastName" class="block text-sm font-semibold leading-6 text-gray-900">{{ __('Nom') }}</label>
                <div class="mt-2.5">
        ...
        <div>
            <label for="phone" class="block text-sm font-semibold leading-6 text-gray-900">{{ __('Téléphone') }}</label>
            <div class="mt-2.5">
