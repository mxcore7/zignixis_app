...
@section('content')
    ...
    <section class="bg-primary-900 py-20 text-white">
        <div class="container-custom text-center">
            <h1 class="text-4xl lg:text-5xl font-display font-bold mb-6">{{ __('Nos Réalisations') }}</h1>
            <p class="text-xl text-gray-200 max-w-2xl mx-auto">
                {{ __('Découvrez comment nous transformons les défis de nos clients en succès digitaux.') }}
            </p>
        </div>
    </section>
        ...
        <div class="container-custom">
            ...
            @else
                <div class="text-center py-16">
                    ...
                    <h3 class="text-lg font-medium text-gray-900">{{ __('Aucune réalisation pour le moment') }}</h3>
                    <p class="mt-2 text-gray-500">{{ __('Revenez bientôt pour découvrir nos derniers projets.') }}</p>
                </div>
            @endif
        </div>
    </section>
    ...
    <section class="bg-gray-50 py-20">
        <div class="container-custom text-center">
            <h2 class="text-3xl font-display font-bold text-gray-900 mb-6">{{ __('Vous avez un projet similaire ?') }}</h2>
            <p class="text-xl text-gray-600 max-w-2xl mx-auto mb-10">
                {{ __('Discutons de vos besoins et voyons comment nous pouvons vous aider à atteindre vos objectifs.') }}
            </p>
